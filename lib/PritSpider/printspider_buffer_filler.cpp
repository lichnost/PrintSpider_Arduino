...
//FreeRTOS queue and uses the printspider_genwaveform code to convert that into a printer
//cart waveform.
...
//the i2s buffers.
int printspider_mem_words_used=0;
...
void /* IRAM_ATTR */ printspider_buffer_filler_fn(void *buf, int len, void *arg) {
	...
	int8_t high_priority_task_awoken = 0;
	...
	//Generate waveform
	printspider_mem_words_used=printspider_generate_waveform((uint16_t*)buf, selected_waveform_tpl, nozdata, selected_waveform_len);
